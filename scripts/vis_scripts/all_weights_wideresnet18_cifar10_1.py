...
datafolder_dkl = "test_dkl_data_wideresnet18_cifar10_1"
datafolder_p2b = "test_p2b_data_wideresnet18_cifar10_1"
datafolder_js_avg = "test_js_avg_data_wideresnet18_cifar10_1"
datafolder_js_unif = "test_js_unif_data_wideresnet18_cifar10"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    for i,reg in enumerate(["dkl","p2b","js_avg","js_unif"]):
        ...
        #single_upper = all_data_ood["baselines"]["single_models"]["mean"]+all_data_ood["baselines"]["single_models"]["se"]
        #single_lower = all_data_ood["baselines"]["single_models"]["mean"]-all_data_ood["baselines"]["single_models"]["se"]
    ...
    plt.suptitle(r'WideResNet 18 Ensemble (M = 4)' +"\n"+'Weighted Training: CIFAR10.1',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_wideresnet_cifar10_1.pdf"))
