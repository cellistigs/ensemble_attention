...
results_dir = os.path.join(base_dir,"scripts/outputs/")
acc = AccuracyData()
...
gamma_ensembles_dkl = {
        -1:"2023-03-16/08-59-34", 
        -0.9:"2023-03-16/19-55-44", 
        -0.5:"2023-03-15/19-45-21", 
        0:"2023-03-15/15-43-34", 
        1:"2023-03-16/12-15-57", 
        2:"2023-03-16/15-34-02", 
        }
gamma_ensembles_p2b = {
        5:"2023-03-17/01-45-17", 
        2.5:"2023-03-17/08-08-18", 
        0:"2023-03-15/23-12-30", 
        -2.5:"2023-03-17/14-32-49", 
       - 5:"2023-03-17/18-22-41", 
        }
gamma_ensembles_js_avg = {
        -3.9:"2023-03-17/21-48-30", 
        -2:"2023-03-18/01-11-20", 
        0:"2023-03-16/02-28-00", 
        2:"2023-03-18/04-34-22", 
        3.9:"2023-03-18/07-57-30", 
        }
gamma_ensembles_js_unif = {
        -1:"2023-03-18/11-16-37", 
        -0.5:"2023-03-18/14-35-18", 
        0:"2023-03-16/05-43-03", 
        }
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'ResNet 34 Ensemble (M = 4)' +"\n"+'Weighted Training: TinyImageNet',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_resnet34_tinyimagenet.pdf"))
