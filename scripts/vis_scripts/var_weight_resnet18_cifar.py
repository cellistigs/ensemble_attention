...
gamma_ensembles = {
        1:"multirun/2022-10-22/19-54-44/0", 
        0:"multirun/2022-10-22/19-54-44/1",
        -10:"multirun/2022-10-24/00-12-41/0",
        10:"multirun/2022-10-24/00-12-41/1",
        -5:"multirun/2022-10-24/14-48-47/0",
        5:"multirun/2022-10-24/14-48-47/1",
        -1:"multirun/2022-10-24/20-32-27/0",
        -2:"multirun/2022-10-24/20-32-27/1",
        -3:"multirun/2022-10-24/20-32-27/2",
        -4:"multirun/2022-10-24/20-32-27/3",
        2:"multirun/2022-10-24/20-32-27/4",
        3:"multirun/2022-10-24/20-32-27/5",
        4:"multirun/2022-10-24/20-32-27/6",
        }
...
def plot(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'ResNet 18 Ensemble (M = 4) Weighted Training: $L_{test}+ \gamma Var()$')
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"var_weight_resnet18_cifar10.pdf"))
