...
resultdict = {
        0.1:"multirun/2023-01-19/15-38-49/0",
        0.2:"multirun/2023-01-19/15-38-49/1",
        0.4:"multirun/2023-01-19/15-38-49/2",
        0.6:"multirun/2023-01-19/15-38-49/3",
        0.8:"multirun/2023-01-19/15-38-49/4",
        1:"multirun/2023-01-19/15-38-49/5",
        0.2:"multirun/2023-01-19/15-38-49/6",
        0.4:"multirun/2023-01-19/15-38-49/7",
        0.6:"multirun/2023-01-19/15-38-49/8",
        0.8:"multirun/2023-01-19/15-38-49/9",
        1:"multirun/2023-01-19/15-38-49/10"
        }
...
def main(args):
    ...
    for resultspath,gamma in resultspaths.items():
        ...
        labelpath = os.path.join(results_dir,"dkl_indiv_cifar100","ensemble_dkl_model_{}_{}_ind_{}".format(gamma,modeltype,"labels"))
        np.save(labelpath,outputs[1].to("cpu"))
        for i in range(len(outputs[0])):
            path = os.path.join(results_dir,"dkl_indiv_cifar100","ensemble_dkl_model_{}_{}_{}_ind_{}".format(i,gamma,modeltype,"preds"))
