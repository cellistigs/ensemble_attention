...
resultdict = {
        -1:"multirun/2023-01-22/07-41-20/0",
        -0.8:"multirun/2023-01-22/07-41-20/1",
        -0.6:"multirun/2023-01-22/07-41-20/2",
        -0.2:"multirun/2023-01-22/07-41-20/3",
        0:"multirun/2023-01-22/07-41-20/4",
        0.2:"multirun/2023-01-22/07-41-20/5",
        0.4:"multirun/2023-01-22/07-41-20/6",
        0.6:"multirun/2023-01-22/07-41-20/7",
        0.8:"multirun/2023-01-22/07-41-20/8",
        1:"multirun/2023-01-22/07-41-20/10"
        }
...
def main(args):
    ...
    for resultspath,gamma in resultspaths.items():
        ...
        labelpath = os.path.join(results_dir,"js_unif_indiv_true_cifar100","ensemble_js_unif_model_{}_{}_ind_{}".format(gamma,modeltype,"labels"))
        np.save(labelpath,outputs[1].to("cpu"))
        for i in range(len(outputs[0])):
            path = os.path.join(results_dir,"js_unif_indiv_true_cifar100","ensemble_js_unif_model_{}_{}_{}_ind_{}".format(i,gamma,modeltype,"preds"))
