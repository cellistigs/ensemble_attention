...
gamma_ensembles_js_avg = {
        -1.4:"multirun/2022-11-10/00-16-07/0",
        -1.9:"multirun/2022-11-10/00-16-07/1",
        -2.4:"multirun/2022-11-10/00-16-07/2",
        -2.9:"multirun/2022-11-10/00-16-07/3",
        -3.4:"multirun/2022-11-10/00-16-07/4",
        -3.9:"multirun/2022-11-10/00-16-07/5",
        1.4:"multirun/2022-11-10/00-16-07/6",
        1.9:"multirun/2022-11-10/00-16-07/7",
        2.4:"multirun/2022-11-10/00-16-07/8",
        2.9:"multirun/2022-11-10/00-16-07/9",
        3.4:"multirun/2022-11-10/00-16-07/10",
        3.9:"multirun/2022-11-10/00-16-07/11",
        -0.4:"multirun/2022-11-10/00-16-07/12",
        -0.8:"multirun/2022-11-10/00-16-07/13",
        0.4:"multirun/2022-11-10/00-16-07/14",
        0.8:"multirun/2022-11-10/00-16-07/15",
        }
...
datafolder_dkl = "test_dkl_data_resnet8_cifar10_1"
datafolder_p2b = "test_p2b_data_resnet8_cifar10_1"
datafolder_js_avg = "../scripts"
datafolder_js_unif = "test_js_unif_data_resnet8_cifar10_1"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'ResNet 8 Ensemble (M = 4)' +"\n"+'Weighted Training: CIFAR10',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_resnet8_cifar10.pdf"))
