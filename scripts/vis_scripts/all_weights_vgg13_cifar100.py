...
datafolder_dkl = "test_dkl_data_vgg13_cifar100/16-30-44"
datafolder_p2b = "test_p2b_data_vgg13_cifar100/08-53-25"
datafolder_js_avg = "test_js_avg_data_vgg13_cifar100"
datafolder_js_unif = "test_js_unif_data_vgg13_cifar100"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'VGG 13 Ensemble (M = 4)' +"\n"+'Weighted Training: CIFAR100',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_vgg13_cifar100.pdf"))
