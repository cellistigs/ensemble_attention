...
datafolder_dkl = "test_dkl_data_vgg11_cifar10_1"
datafolder_p2b = "test_p2b_data_vgg11_cifar10_1/17-18-21"
datafolder_js_avg = "test_js_avg_data_vgg11_cifar10_1/00-19-50"
datafolder_js_unif = "test_js_unif_data_vgg11_cifar10_1"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'VGG 11 Ensemble (M = 4)' +"\n"+'Weighted Training: CIFAR10.1',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_vgg11_cifar10_1.pdf"))
