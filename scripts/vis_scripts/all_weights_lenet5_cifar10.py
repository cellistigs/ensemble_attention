...
base_resnets = {
    "ResNet 8":os.path.join(results_dir,"dkl_indiv_small_cifar100","ensemble_dkl_model_0_1_resnet8_cifar100_"),#"resnet8_0/",
    "ResNet 8.7":os.path.join(results_dir,"dkl_indiv_small_cifar100","ensemble_dkl_model_1_1_resnet8_cifar100_"),#"resnet8_1/",
    "ResNet 8.8":os.path.join(results_dir,"dkl_indiv_small_cifar100","ensemble_dkl_model_2_1_resnet8_cifar100_"),#"resnet8_2/",
    "ResNet 8.9":os.path.join(results_dir,"dkl_indiv_small_cifar100","ensemble_dkl_model_3_1_resnet8_cifar100_"),#"resnet8_3/",
...
gamma_ensembles_dkl = {
        0-1:"2023-01-25/14-03-26", 
        0.2-1:"2023-01-03/10-36-36", 
        0.5-1:"2023-01-03/10-36-33", 
        1-1:"2023-01-25/14-06-08", 
        1.2-1:"2023-01-04/11-25-26", 
        1.5-1:"2023-01-04/11-25-54", 
        2-1:"2023-01-04/11-28-50", 
        }
gamma_ensembles_p2b = {
        -5:"10", 
        -4:"9", 
...
datafolder_dkl = "lenet5"
datafolder_js_avg = "test_js_avg_data_lenet5_cifar10_1"
datafolder_js_unif = "test_js_unif_data_lenet5_cifar10_1"
datafolder_p2b = "test_p2b_data_lenet5_cifar10_1/01-22-02"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    plt.suptitle(r'LeNet 5 Ensemble (M = 4)' +"\n"+'Weighted Training: CIFAR10',size = "xx-large")
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_LeNet5_cifar10.pdf"))
