...
datafolder_dkl = "test_dkl_data_wideresnet18_cifar100"
datafolder_p2b = "test_p2b_data_wideresnet18_cifar100"
#datafolder_js_avg = "test_js_avg_data_widresnet18_cifar100"
datafolder_js_unif = "test_js_unif_data_wideresnet18_cifar100"

all_gamma_ensembles = {
                        #"dkl":gamma_ensembles_dkl,
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    ax = [ax]
    for i,reg in enumerate(["js_unif"]):
    ...
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_wideresnet_cifar100.pdf"))
