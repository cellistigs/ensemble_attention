...
datafolder_dkl = "test_dkl_data_small_cifar100"
datafolder_js_avg = "test_p2b_data_small_cifar100/10-56-33"
datafolder_js_unif = "test_js_unif_data_small_cifar100"
datafolder_p2b = "test_js_avg_data_small_cifar100"
...
def plot_main(all_data_ind,all_data_ood):    
    ...
    ax[0].legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir,"all_weight_resnet8_cifar100.pdf"))
